...
namespace GameProtocol.constans
{
    ...
    public class HeroData
    {
        ...
        static HeroData()
        {
            create(1, "阿狸", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f,3, 6, 1, 2, 3, 4);
            create(2, "阿木木", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 3, 3, 1, 2, 3, 4);
            create(3, "埃希", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 3, 1, 6, 2, 3, 4);
            create(4, "盲僧", 100, 20, 500, 300, 5, 2, 30, 10, 1, 0.5f, 3, 1, 3, 2, 3, 4);
        }
        /// <summary>
        /// 创建模型并添加进字典
        /// </summary>
