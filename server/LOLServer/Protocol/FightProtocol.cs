...
namespace GameProtocol
{
    public class FightProtocol
    {
        ...
        public const int REFRESH_BRO = 12;//刷怪
        public const int OVER_BRO = 13;//游戏结束了

        public const int GET_EQU_CREQ = 14;
        public const int GET_EQU_BRO = 15;
        public const int GET_EQU_SRES = 16;
        public const int op = 17;//通用操作
    }
}
